export const useQuotes = () => {
    const QuotesList = [
        ...
        {
            quote: "A coder is a poet.",
            author: "Venktesh Soma"
        },
        {
        ...
        {
            quote: "All you need in this life is ignorance and confidence; then success is true.",
            author: "Mark Twain"
        },
        {
        ...
        {
            quote: "The only guarantee for failure is stop trying.",
